...
def augment_subqueries(queries):
    ...
    prompt_template = Template("""
        ...
        5. for each group, convert this group of triplets into a readable text rather than graph, do not adding any other interpretation or information.
        6. output the final strings, which is just a concatenation of the all the rephased text of the groups.
        text:
        $text
    """)
    user_prompt = prompt_template.substitute(
